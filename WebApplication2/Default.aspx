...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main class="container body-content pt-4 pb-xl-4">
        <section class="row pb-4" aria-labelledby="aspnetTitle">
            <h1 id="aspnetTitle" class="fw-bold text-center">歡迎來到 TeamC</h1>
            <p class="lead text-center">您可以在本網站中進行租車、買車、賣車以及租借司機的服務</p>
            <div class="d-grid gap-2 col-3 mx-auto">
                <a class="btn btn btn-primary" href="#gettingStartedTitle">立即體驗網站服務</a>
            </div>
        </section>
        ...
        <div class="row pt-4 pb-xl-4">
            <section class="col-md-4" aria-labelledby="gettingStartedTitle">
                <div aria-labelledby="gettingStartedTitle">
                    ...
                    <h2 class="col-sm-8 mt-2 fw-bold ">我要購買</h2>
                </div>
                <p>
                    想購買最佳的車輛嗎? 您可以在此選擇心儀的車輛進行購買
                    <br />
                    <br />
                </p>
                <div>
            ...
            <section class="col-md-4" aria-labelledby="librariesTitle">
                <div aria-labelledby="gettingStartedTitle">
                    ...
                    <h2 class="col-sm-8 mt-2 fw-bold ">我要租借</h2>
                </div>
                <p>
                    不想購買只想租借嗎? 您可以在此租借車子以及司機
                    <br />
                    <br />
                </p>
                <div>
            ...
            <section class="col-md-4" aria-labelledby="hostingTitle">
                <div aria-labelledby="gettingStartedTitle">
                    ...
                    <h2 class="col-sm-8 mt-2 fw-bold ">我有問題</h2>
                </div>
                <p>
        ...
        <div class="container">
            <div class="row row d-flex justify-content-center align-items-center">
                ...
                <div class="col text-center pt-xxl-4">
                    ...
                    <p class="lead text-white pt-4">
                        <a href="https://www.google.com/maps?q=106335+臺北市大安區基隆路4段43號" class="text-white" style="text-decoration: none;" target="_blank">106335 臺北市大安區基隆路 4 段 43 號</a>
                    </p>
                </div>
            </div>
            <div>
