<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="driver.aspx.cs" Inherits="WebApplication2.search.driver" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="pt-xxl-4 pb-xxl-4"></div>
    <div class="pt-xxl-4 pb-xxl-4"></div>
    <div class="pt-xxl-4 pb-xxl-4"></div>
    <h1 style="text-align: center">Find Driver</h1>
    <div class="pt-xxl-4 pb-xxl-4"></div>
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="input-group flex-nowrap">
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Placeholder="Driver ID" aria-label="產品ID" aria-describedby="addon-wrapping"></asp:TextBox>
                </div>
            </div>
            <div class="col">
                <div class="input-group flex-nowrap">
                    ...
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" Placeholder="Age" aria-label="Username" aria-describedby="addon-wrapping"></asp:TextBox>
                </div>
            </div>
            <div class="col">
                <div class="col">
                    <div class="input-group flex-nowrap">
                        ...
                        <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" Placeholder="Phone" aria-label="Username" aria-describedby="addon-wrapping"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="col">
                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" CssClass="form-select" AppendDataBoundItems="true" aria-label="Default select example">
                    <asp:ListItem Text="Choose Price" Value="" Selected="True"></asp:ListItem>
                </asp:DropDownList>
            </div>
            <div class="col-1">
    ...
    <div class="container body-content" style="width: 100%; overflow-y: auto;">
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="driver_id" CellPadding="4" ForeColor="#333333" GridLines="None">
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:TeamCConnectionString5 %>' ProviderName='<%$ ConnectionStrings:TeamCConnectionString5.ProviderName %>' SelectCommand="SELECT [driver_id], [age], [price], [phoneNumber] FROM [Driver]"></asp:SqlDataSource>
</asp:Content>
