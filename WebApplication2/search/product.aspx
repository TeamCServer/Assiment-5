        ...
        <div class="row">
            <div class="col">
                <div class="input-group flex-nowrap">
                    ...
                    <asp:TextBox ID="TextBox18" runat="server" CssClass="form-control" Placeholder="Product ID" aria-label="產品ID" aria-describedby="addon-wrapping"></asp:TextBox>
                </div>
            </div>
            <div class="col">
                <div class="input-group flex-nowrap">
                    ...
                    <asp:TextBox ID="TextBox19" runat="server" CssClass="form-control" Placeholder="Product Name" aria-label="Username" aria-describedby="addon-wrapping"></asp:TextBox>
                </div>
            </div>
            <div class="col">
                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" CssClass="form-select" AppendDataBoundItems="true" aria-label="Default select example">
                    <asp:ListItem Text="Payment" Value="" Selected="True"></asp:ListItem>
                </asp:DropDownList>
            </div>
            <div class="col">
                <div class="col">
                    <div class="input-group flex-nowrap">
                        ...
                        <asp:TextBox ID="TextBox20" runat="server" CssClass="form-control" Placeholder="Address" aria-label="Username" aria-describedby="addon-wrapping"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="col-1">
