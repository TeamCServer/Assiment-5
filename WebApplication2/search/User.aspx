...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container body-content" style="width: 100%; overflow-y: auto;">
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataKeyNames="user_id" CellPadding="4" ForeColor="#333333" GridLines="None">
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:TeamCConnectionString5 %>' SelectCommand="SELECT [user_id], [firstName], [lastName], [email] FROM [Users]"></asp:SqlDataSource>
    </div>
</asp:Content>
